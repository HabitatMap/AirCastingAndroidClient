...
public class BitmapHolder {
    ...
    private static final RemovalListener<BitmapKey, Bitmap> listener = new RemovalListener<BitmapKey, Bitmap>() {
        @Override
        public void onRemoval(RemovalNotification<BitmapKey, Bitmap> notification) {
            Bitmap value = notification.getValue();
            if (value != null) {
                value.recycle();
            }
        }
