...
/**
 * An entity that provides {@link ioio.lib.util.IOIOLooper} instances on demand, per
...
public interface IOIOLooperProvider
{
	 ...
	 * {@link ioio.lib.util.IOIOLooper}. The caller provide enough information to uniquely
	 ...
	 * 
	 * @return An implementation of {@link ioio.lib.util.IOIOLooper}, or <code>null</code> to
	 *         skip.
	 */
