...
public class SensorRepository implements DBConstants {
    public static final String[] SENSOR_FIELDS = new String[]{STREAM_SENSOR_NAME, STREAM_MEASUREMENT_TYPE,
    ...
    public List<Sensor> getAll() {
        ...
        while (!cursor.isAfterLast()) {
            ...
            Sensor sensor = new Sensor(name, measurementType, unit, symbol, veryLow, low, mid, high, veryHigh);
            result.add(sensor);
